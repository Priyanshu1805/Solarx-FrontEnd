...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the team behind SOLAREX ENERGY. Founded by Priyanshu Talvekar, we've helped 500+ families and businesses across Maharashtra switch to clean solar power." },
    ],
  }),
  component: AboutPage,
});
...
const values = [
  { icon: Target, title: "Our Mission", text: "To make premium solar energy accessible, affordable and reliable for every home, business and farm across central India — accelerating Maharashtra's transition to clean power." },
  { icon: Eye, title: "Our Vision", text: "A Vidarbha powered entirely by the sun. Where every rooftop generates its own electricity, every farmer pumps water without diesel, and every business runs on clean energy." },
  { icon: Heart, title: "Our Values", text: "Honest pricing, premium components, and lifelong partnership. We don't disappear after the installation — we stay with you for the 25-year journey." },
];
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={homeImg} alt="" className="h-full w-full object-cover opacity-20" width={1536} height={1024} />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Since our founding, SOLAREX ENERGY has helped 500+ homes, farms and
            businesses across Maharashtra harness the power of the sun — saving
            crores in electricity bills and offsetting thousands of tonnes of CO₂.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground">
              <p>
                SOLAREX ENERGY was born from a simple observation: Nagpur receives
                over 300 days of strong sunshine every year, yet most rooftops sit
                empty while electricity bills climb.
              </p>
              <p>
                We set out to change that — not by selling cheap kits, but by engineering
                premium solar systems that genuinely deliver 25+ years of clean power.
                Every system we install uses MNRE-approved tier-1 panels, certified
                inverters, and is backed by our in-house AMC team.
              </p>
              <p>
                Today, we're proud to be the solar partner of choice for hundreds
                of families across Manish Nagar, Civil Lines, Pratap Nagar, and the
                MIDC industrial belt of Hingna and Butibori.
              </p>
            </div>
          </div>
          <img src={cellsImg} alt="Solar panel cells" loading="lazy" width={1536} height={1024} className="rounded-3xl shadow-soft" />
        </div>
      </section>
