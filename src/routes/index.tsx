  ...
  head: () => ({
    meta: [
      { title: "SOLAREX ENERGY — Power Your Future Naturally | Nagpur Solar" },
      {
        name: "description",
        content:
          "Reduce your electricity bills by up to 90% with premium solar solutions from SOLAREX ENERGY. Free consultation in Nagpur, Maharashtra.",
      },
    ],
  }),
  component: HomePage,
...
const benefits = [
  {
    ...
    desc: "Cut electricity costs by up to 90% from day one.",
  },
  {
    icon: Leaf,
    title: "Clean & Green",
    desc: "Reduce your carbon footprint with renewable energy.",
  },
  {
    icon: Shield,
    title: "25-Year Warranty",
    desc: "Premium tier-1 panels backed by long-term protection.",
  },
  {
    icon: Zap,
    title: "Quick Installation",
    desc: "Most residential systems live within 7 working days.",
  },
];
...
const testimonials = [
  {
    ...
    quote:
      "My electricity bill dropped from ₹8,200 to just ₹450 per month. SOLAREX made the entire process effortless.",
  },
  {
    name: "Anita Deshmukh",
    role: "Factory Owner, MIDC Hingna",
    quote:
      "We installed a 50kW system across our factory roof. Payback in under 4 years — best investment we've made.",
  },
  {
    name: "Kishore Patil",
    role: "Farmer, Kalmeshwar",
    quote:
      "The solar pump runs my drip irrigation all day. No more diesel costs, no power cuts during the season.",
  },
  {
    name: "Meena Kulkarni",
    role: "Shop Owner, Sitabuldi",
    quote:
      "Reliable team, transparent pricing, and the savings started from the very first month. Highly recommend.",
  },
  {
    name: "Sunil Joshi",
    role: "Housing Society, Civil Lines",
    quote: "Our society of 48 flats switched to solar. Common-area bills are essentially zero now.",
  },
  {
    name: "Pooja Agrawal",
    role: "Homeowner, Pratap Nagar",
    quote:
      "Priyanshu and his team are genuine professionals. They explained every component clearly before installing.",
  },
];
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:py-32">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Slash your electricity bills by up to 90% with premium solar systems designed,
              installed and maintained by SOLAREX ENERGY — Nagpur's most trusted solar specialists.
            </p>
          ...
          <div className="relative hidden md:block">
            ...
            <img
              src={homeImg}
              alt="Solar-powered home in Nagpur"
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-4 md:grid-cols-4">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="rounded-2xl border border-border bg-card p-6 transition-all hover:border-primary hover:shadow-soft"
            >
          ...
          <div className="relative grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-4 max-w-md text-base opacity-90">
                A typical 5kW residential system pays for itself in 3–4 years and keeps producing
          ...
          {[
            {
              n: "01",
              t: "Free Consultation",
              d: "Site visit and personalised savings report — no obligation.",
            },
            { n: "02", t: "Custom Design", d: "System sized to your roof, usage and budget." },
            {
              n: "03",
              t: "Installation",
              d: "Certified engineers, premium components, 7-day turnaround.",
            },
            {
              n: "04",
              t: "Ongoing AMC",
              d: "Annual maintenance keeps your system performing at peak.",
            },
          ].map((s) => (
